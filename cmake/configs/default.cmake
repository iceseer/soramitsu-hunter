...
hunter_default_version(Clang VERSION 12.0.1-p0)
hunter_default_version(ClangToolsExtra VERSION 12.0.1) # Clang
...
hunter_default_version(IlmBase VERSION 2.4.0-p1)
...
hunter_default_version(OpenEXR VERSION 2.4.0-p1)
hunter_default_version(OpenNMTTokenizer VERSION 1.11.0-p1)
hunter_default_version(OpenSSL VERSION 1.1.1l)
...
hunter_default_version(SQLiteModernCpp VERSION 0.0.0)
...
hunter_default_version(Vulkan-Headers VERSION 1.2.133-p0)
...
hunter_default_version(absl VERSION 20200225.2)
...
hunter_default_version(asio VERSION 1.12.2-8d6df7b-p1)
...
hunter_default_version(doctest VERSION 2.3.7)
...
hunter_default_version(erasure_coding_crust VERSION 0.0.2)
...
hunter_default_version(glslang VERSION 7.12.3352-p1)
hunter_default_version(glu VERSION 9.0.1-p0)
...
hunter_default_version(leveldb VERSION 1.22-s0)
...
hunter_default_version(libjpeg-turbo VERSION 2.0.3-p0)
...
hunter_default_version(libp2p VERSION 0.1.9)
...
hunter_default_version(libsecp256k1 VERSION 0.1)
...
hunter_default_version(prometheus-cpp VERSION 0.12.3-p0)
...
hunter_default_version(rocksdb VERSION 7.2.2)
...
hunter_default_version(tsl_hat_trie VERSION 1.0.0)
...
hunter_default_version(wavm VERSION 1.0.6)
